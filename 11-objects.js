// multiple data type use (objects).
// similar data type use (array).

//* ==============================
//* Object in JavaScript
//* ==============================
//? Objects are a fundamental part of JavaScript, providing a way to group related data and functions together.
// In JavaScript, an object is a collection of key-value pairs, where each key is a string (or a symbol) and each
// value can be any data type, including other objects. Objects can have properties and methods, making them
...
// person["job"] = "web dev"; //add
// // person.age = 18;  //modify
...
//* Methods:
//* =================================
// A method is a function stored inside an object. Here, `greet` is a method because it contains a function.
// Methods in objects are functions associated with the object. They can be invoked using the same
// notation as properties:
...
// // We use [ ] when we want to use a variable's value as an object key. This is called a dynamic key.
// let student = {
// // studentId
