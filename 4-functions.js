...
//todo Tips "1st declare the function & then call it" In JavaScript, it's a good 
// practice to declare (define) your functions before you call them. This ensures 
// that the function is available for use when you try to call it.
...
//! Write a JavaScript program that defines a function called greet to welcome individuals
//  to the syeda rida. The function should take a name parameter and output the message 
// "Hello [name], Welcome to syeda rida JS Course". 
// Call the function twice, once with the argument "Atruba" and once with the argument "rida".
// function greet(name) {
//     console.log("Hello " + name + ", Welcome to ", name, " JS Course");
// }
// greet('Syeda Rida');
// greet('Atruba');
// greet('Rida');
...
// It can be either named or anonymous. If it's named, it becomes a named function expression.
...
//*  Return Keyword
//* =============================
//? Return Keyword: In JavaScript, the return statement is used within a 
// function to specify the value that the function should produce or provide 
// back to the code that called it. The return statement stops the execution 
...
//* =============================
//? An IIFE, or Immediately Invoked Function Expression, is a JavaScript function 
// that is defined and executed immediately after its creation. It is a way to create 
// a self-contained block of code that doesn't interfere with the surrounding code and 
