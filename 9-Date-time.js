...
// In this format, the date and time are represented together, separated by the 
// letter "T". The "Z" at the end indicates that the time is in UTC (Coordinated Universal Time).
...
// 7: new Date(year, month, day, hours, minutes, seconds): Creates a Date object with the specified 
// year, month, day, hours, minutes, and seconds.
// const date5 = new Date(2024, 1, 19, 10, 44, 9);
// console.log(date5);

// 8: new Date(year, month, day, hours, minutes, seconds, ms): Creates a Date object with the specified 
// year, month, day, hours, minutes, seconds, and milliseconds.
// const date6 = new Date(2024, 1, 19, 10, 44, 9, 274);
// console.log(date6);

// 9: new Date(milliseconds): Creates a Date object representing the number of milliseconds since 
// the Unix epoch (January 1, 1970, 00:00:00 UTC).
// const curMilliSeconds = new Date().getTime();
// console.log(curMilliSeconds);

// const milliseconds = 1789723445181; // Example milliseconds
...
// 2: JavaScript Stores Dates as Milliseconds: JavaScript stores dates as number of milliseconds 
...
//* ===================================================
// const date = new Date();
// setFullYear(yearValue[, monthValue[, dayValue]]): Sets the full year for a specified 
...
// setHours(hourValue[, minuteValue[, secondValue[, millisecondValue]]]): Sets the hours for a 
// specified date according to local time.
// date.setHours(10);
// console.log(date); // Date object with the hours set to 10

// setMinutes(minuteValue[, secondValue[, millisecondValue]]): Sets the minutes for a specified date
...
// setTime(timeValue): Sets the Date object to the time represented by a number of milliseconds since 
...
// 1: toLocaleString(): Returns a string representing the date and time portion of a Date object 
...
// 2: toLocaleDateString(): Returns a string representing the date portion of a Date object using 
// the current locale's conventions.
// const date = new Date();
// const localDateString = date.toLocaleDateString();
// console.log(localDateString); // Example output: "2/19/2024" (depending on the locale)

// 3: toLocaleTimeString(): Returns a string representing the time portion of a Date object 
//  using the current locale's conventions.
// const date = new Date();
// const localTimeString = date.toLocaleTimeString();
// console.log(localTimeString); // Example output: "4:30:00 PM" (depending on the locale)

// 5: parse(): Parses a string representation of a date and returns the number of milliseconds 
...
// function getNewDate(e, add) {
//     console.log(e);
//     // console.log(e.setDate(e.getDate() + add));
//     // console.log(new Date(1801267200000));
//     let update = e.setDate(e.getDate() + add);
//     return new Date(update);
// }

// const date = new Date('2027-01-25');
// const newDate = getNewDate(date, 5);
// console.log(newDate);
