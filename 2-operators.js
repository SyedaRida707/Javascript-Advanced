...
//*  InterView Question
//* ====================================
// JavaScript gives 0.30000000000000004 instead of 0.3 because 0.1 and 0.2 
// cannot be represented exactly in binary, causing a floating-point precision error.

// it is not a JavaScript error. It is a floating-point precision issue 
// caused by how computers represent decimal numbers in binary.
...
//* 6: Unary operator
//* ====================================
//? Unary operators in JavaScript are operators that work with only one operand. 
// They perform various operations such as negation, incrementing, decrementing, 
// type conversion, and more.

//? Unary Plus (+): Converts its operand into a number. If the operand is not already a number,
//  it attempts to convert it.
// console.log(+3);
// console.log(+"5");

//? Unary Negation (-): Negates its operand, converting non-numbers into numbers and then
//  negating them.
// console.log(-5);
// console.log(-"3");

//? Prefix Increment (++x) and Prefix Decrement (--x): 
// In prefix form, the value of the operand is first incremented or decremented, 
...
// In postfix form, the value of the operand is first returned, 
...
// Let say you have a variable score representing a student's exam score.
// If the score is greater than or equal to 60, the student passes; otherwise, 
// they fail. Use the conditional (ternary) operator to determine the result and 
// store it in a variable called result. Log the result to the console❓
