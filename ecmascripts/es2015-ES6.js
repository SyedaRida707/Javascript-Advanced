...
// but once a value is assigned to a const variable, it cannot be reassigned. const variables are immutable.
...
//? String Interpolation:  Template strings support string interpolation, allowing you to embed expressions 
// directly within the string. Interpolated expressions are enclosed in ${}
...
// parameters in the function declaration itself. If a parameter is not provided when the function is called, 
...
//? In ECMAScript 6 (ES6), arrow functions, also known as fat arrow functions, were introduced as a concise way 
...
// //?🚀 1: If the function body consists of a single expression, the braces {} and the return keyword 
// can be omitted.
...
// Instead of specifying name: name and age: age, you can simply use name and age directly within 
// the object literal, thanks to ES6 shorthand property notation.
...
// Distinct variables means separate or different variables. like first
// const first = numbers[0]; // Traditional way

// Destructuring
// const [first, second, third] = numbers;
// console.log(second); second is Distinct variables
...
// a store b and b store a [b,a]
// [a, b] = [b, a];
// console.log(a, b);

//* Destructuring Objects:
// const user = { name: "rida", age: 21 };
...
// dont use own name use object key exact name
...
// array ke elements ko unpack karke push() mein add kar do. like = 'guava', 'grapes'
// fruits.push(...["guava", "grapes"]);
// console.log(fruits);
